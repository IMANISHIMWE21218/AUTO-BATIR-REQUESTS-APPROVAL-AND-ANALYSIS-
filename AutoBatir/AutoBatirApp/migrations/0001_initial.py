    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Address', models.CharField(blank=True, choices=[('male', 'male'), ('female', 'female')], max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NationalID', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='AutoBatirApp.nationalid')),
            ],
            options={
                'db_table': 'UPI',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(default=None, primary_key=True, serialize=False)),
                ('personal_National_Id', models.CharField(max_length=18)),
                ('FirstName', models.CharField(blank=True, max_length=35, null=True)),
                ('LastName', models.CharField(blank=True, max_length=35, null=True)),
                ...
                ('NationalID', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='AutoBatirApp.nationalid', verbose_name='registration letated to national Id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Address_street', models.CharField(blank=True, max_length=1000, null=True)),
                ('gender', models.CharField(blank=True, choices=[('male', 'male'), ('female', 'female')], max_length=10, null=True)),
                ('NationalID', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='AutoBatirApp.nationalid', verbose_name='engineer letated to national Id')),
                ('user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Engineer',
